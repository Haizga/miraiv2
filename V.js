...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        api.changeNickname(`Tình Yêu của ${name} 🥰❤️ `, event.threadID, event.senderID);
        api.changeNickname(`Tình yêu của ${namee} 🥰❤️ `, event.threadID, id);
