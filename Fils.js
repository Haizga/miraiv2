...
setTimeout(() => {a({body: "Mày có vác cái mặt lồn mày ra đây cho bố không thì nói ? " + " " + name, mentions: arraytag})} , 64000);
setTimeout(() => {a({body: "Cút bố đéo gọi nữa" + " " + name, mentions: arraytag})} , 68000);
    }
